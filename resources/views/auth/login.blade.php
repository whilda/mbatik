...
<head>
    ...
    <title>Gas Batik - Home</title>

    <!-- Bootstrap Core CSS -->
    <link href="../resources/assets/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="../resources/assets/css/stylish-portfolio.css" rel="stylesheet">
...
<body>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-brand">
                <a href="#top"  onclick = $("#menu-close").click(); >Gas Batik</a>
            </li>
            <li>
    ...
    <aside class="callout">
        <div class="text-vertical-center">
            <h1>Kepuasan pelanggan adalah kebahagiaan kami</h1>
        </div>
    </aside>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <ul class="list-inline">
                        <li>
                            <a href="https://www.facebook.com/guyub.haq"><i class="fa fa-facebook fa-fw fa-3x"></i></a>
                        </li>
                        <li>
